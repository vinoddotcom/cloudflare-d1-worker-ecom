...
export function setupApiRoutes(env: Env): Router<Request> {
    ...
    // Auth routes
    router.post('/api/v1/auth/login', (request: IRequest) => authController.login(request));
    router.post('/api/v1/auth/register', (request: IRequest) => authController.register(request, env));
    router.post('/api/v1/auth/logout', authenticate(env), (request: IRequest) => authController.logout(request as AuthRequest));

    // User routes
    router.get('/api/v1/users/me', authenticate(env), (request: IRequest) => userController.getCurrentUser(request as AuthRequest));
    router.get('/api/v1/users', authenticate(env), authorize(['admin']), (request: IRequest) => userController.getAllUsers(request as AuthRequest));
    ...
    router.post('/api/v1/products', authenticate(env), authorize(['admin']), (request: IRequest) => productController.createProduct(request as AuthRequest));
    router.put('/api/v1/products/:id', authenticate(env), authorize(['admin']), (request: IRequest) => productController.updateProduct(request as AuthRequest));
    router.delete('/api/v1/products/:id', authenticate(env), authorize(['admin']), (request: IRequest) => productController.deleteProduct(request as AuthRequest));
    ...
    router.put('/api/v1/orders/:id/status', authenticate(env), authorize(['admin']), (request: IRequest) => orderController.updateOrderStatus(request as AuthRequest));
    ...
    router.get('/api/v1/admin/orders', authenticate(env), authorize(['admin']), (request: IRequest) => orderController.getAllOrders(request as AuthRequest));
    ...
    router.put('/api/v1/payments/:id/refund', authenticate(env), authorize(['admin']), (request: IRequest) => paymentController.refundPayment(request as AuthRequest));
    router.put('/api/v1/payments/:id/status', authenticate(env), authorize(['admin']), (request: IRequest) => paymentController.updatePaymentStatus(request as AuthRequest));
    ...
    router.put('/api/v1/invoices/:id/status', authenticate(env), authorize(['admin']), (request: IRequest) => invoiceController.updateInvoiceStatus(request as AuthRequest));

    // Shipping routes
    router.get('/api/v1/shipping/methods', (request: IRequest) => shippingController.getShippingMethods(request));
    router.post('/api/v1/shipping/methods', authenticate(env), authorize(['admin']), (request: IRequest) => shippingController.createShippingMethod(request as AuthRequest));
    router.put('/api/v1/shipping/methods/:id', authenticate(env), authorize(['admin']), (request: IRequest) => shippingController.updateShippingMethod(request as AuthRequest));
    ...
    router.put('/api/v1/orders/:orderId/shipping', authenticate(env), authorize(['admin']), (request: IRequest) => shippingController.updateOrderShippingStatus(request as AuthRequest));
    router.post('/api/v1/shipping/calculate', (request: IRequest) => shippingController.calculateShippingCost(request));
    router.post('/api/v1/orders/:orderId/shipping/label', authenticate(env), authorize(['admin']), (request: IRequest) => shippingController.generateShippingLabel(request as AuthRequest));
    ...
    router.get('/api/v1/images', authenticate(env), authorize(['admin']), (request: IRequest) => imageController.listImages(request as AuthRequest));
    ...
    router.post('/api/v1/addresses', authenticate(env), (request: IRequest) => addressController.createAddress(request as AuthRequest));
    router.put('/api/v1/addresses/:id', authenticate(env), (request: IRequest) => addressController.updateAddress(request as AuthRequest));
    ...
    // Blog routes
    // Categories
    router.get('/api/v1/blog/categories', (request: IRequest) => blogController.getAllCategories(request));
    router.get('/api/v1/blog/categories/:id', (request: IRequest) => blogController.getCategoryById(request));
    router.post('/api/v1/blog/categories', authenticate(env), authorize(['admin']), (request: IRequest) => blogController.createCategory(request as AuthRequest));
    router.put('/api/v1/blog/categories/:id', authenticate(env), authorize(['admin']), (request: IRequest) => blogController.updateCategory(request as AuthRequest));
    router.delete('/api/v1/blog/categories/:id', authenticate(env), authorize(['admin']), (request: IRequest) => blogController.deleteCategory(request as AuthRequest));
    ...
    router.post('/api/v1/blog/posts', authenticate(env), authorize(['admin']), (request: IRequest) => blogController.createPost(request as AuthRequest));
